...
func runConformance(t *testing.T, newStore func(t *testing.T) store.Store) {
	...
	tests := []struct {
		...
		{"PartialCreditDoesNotSettle", testPartialCreditDoesNotSettle},
		{"ExpectedCreditAllowsAFee", testExpectedCreditAllowsAFee},
		{"OverpaymentGoesToAHuman", testOverpaymentGoesToAHuman},
		{"PartialSettlementStillOrphans", testPartialSettlementStillOrphans},
		...
		{"ExposureCountsOnlyTheShortfall", testExposureCountsOnlyTheShortfall},
